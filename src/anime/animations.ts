import { getAnimationType } from "./values";

import { normalizeTweens } from "./tweens";

function createAnimation(animatable: any, prop: any) {
...
export function getAnimations(animatables: any, properties: any) {
	const animations = [];
